...
export default function UploadCenter() {
  ...
  const processNextItem = async () => {
    ...
    try {
      ...
      const isUrlUpload = !!nextItem.sourceUrl;
        ...
        try {
          ...
          const message =
            err && typeof err === "object" && "response" in err
              ...
              ? err.message
              : undefined;
          throw new Error(message || "Gagal mendapatkan izin upload");
        }
                    ...
                    <div className="space-y-3 pt-2 animate-in fade-in slide-in-from-top-2">
                       <div className="space-y-2">
                          ...
                          <Select 
                            ...
                            onValueChange={(val: "original" | "webp" | "jpeg" | "png") => updateQueueItem(editingItem.id, { 
                    ...
                    <div className="space-y-3 pt-2 animate-in fade-in slide-in-from-top-2">
                       <div className="space-y-2">
                          ...
                          <Select 
                            ...
                            onValueChange={(val: "original" | "mp4" | "webm") => updateQueueItem(editingItem.id, { 
                        ...
                        <div className="space-y-2">
                          ...
                          <Select 
                            ...
                            onValueChange={(val: "auto" | "high" | "medium" | "low") => updateQueueItem(editingItem.id, { 
